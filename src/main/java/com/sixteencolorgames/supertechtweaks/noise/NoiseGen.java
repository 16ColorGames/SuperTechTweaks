package com.sixteencolorgames.supertechtweaks.noise;
/*
...
public class NoiseGen {
	 ...
	 * <i>value</i>-noise function. Most noise modules use gradient noise for this
	 * reason, although it takes much longer to calculate.
	 * <p/>
	 * The return value ranges from -1.0 to +1.0.
	 * <p/>
	 * This function generates a gradient-noise value by performing the following
	 * steps: - It first calculates a random normalized vector based on the nearby
	 * integer value passed to this function. - It then calculates a new value by
	 * adding this vector to the nearby integer value passed to this function. - It
	 * then calculates the dot product of the above-generated value and the
	...
	/**
	 * Modifies a floating-point value so that it can be stored in a noise::int32
	 * variable.
	 * <p/>
	 * This function does not modify @a n.
	 * <p/>
	 * In libnoise, the noise-generating algorithms are all integer-based; they use
	 * variables of type noise::int32. Before calling a noise function, pass the @a
	 * x, @a y, and @a z coordinates to this function to ensure that these
	 * coordinates can be cast to a noise::int32 value.
	 * <p/>
