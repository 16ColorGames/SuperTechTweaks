...
public abstract class Interp {
	 ...
	 * function returns @a n1. If the alpha value is 1.0, this function returns @a
	 * n2.
	 *
	 ...
	 * <p/>
	 * The alpha value should range from 0.0 to 1.0. If the alpha value is 0.0, this
	 * function returns @a n0. If the alpha value is 1.0, this function returns @a
	 * n1.
	 *
	 ...
	 *
	 * @param a The value to map onto a cubic S-curve. (should range from 0.0 to
	 *          1.0)
	 ...
	 * <p/>
	 * The first derivitive of a quintic S-curve is zero at @a a = 0.0 and @a a =
	 * 1.0
	 * <p/>
	 * The second derivitive of a quintic S-curve is zero at @a a = 0.0 and @a a =
	 * 1.0
	 *
	 * @param a The value to map onto a quintic S-curve. (should range from 0.0 to
	 *          1.0)
	 * @return The mapped value.
	 */
