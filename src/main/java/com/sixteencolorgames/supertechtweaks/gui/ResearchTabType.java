...
enum ResearchTabType {
	...
	private ResearchTabType(int p_i47386_3_, int p_i47386_4_, int widthIn, int heightIn, int p_i47386_7_) {
	...
	public void draw(Gui guiIn, int x, int y, boolean p_192651_4_, int p_192651_5_) {
		...
		guiIn.drawTexturedModalRect(x + this.getX(p_192651_5_), y + this.getY(p_192651_5_), i, j, this.width,
				this.height);
	}
	...
	static {
		...
		for (ResearchTabType researchtabtype : values()) {
			i += researchtabtype.max;
		}
