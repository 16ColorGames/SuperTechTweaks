...
public enum Ores implements IStringSerializable {
    ...
    TERRAX("Terrax", "0x000000", 4, 5),
    KARMESINE("Karmesine", "0x000000", 4),
    OVIUM("Ovium", "0x000000", 4),
    JAUXUM("Jauxum", "0x000000", 4),
    AURORIUM("Aurorium", "0x000000", 4, 5),
    TIBERIUM("Tiberium", "0xD4FF00", 2, 3),
    DILITHIUM("Dilithium", "0x000000", 2),
    FRACTUM("Fractum", "0x000000", 3, 4),
    TRIBERIUM("Triberium", "0x000000", 3, 3),
    ABYSSUM("Abyssum", "0x000000", 4),
    TRITONITE("Tritonite", "0x000000", 8, 8),
    VIOLIUM("Violium", "0x000000", 7, 8),
    ASTRIUM("Astrium", "0x000000", 5, 6),
    NIHILITE("Nihilite", "0x000000", 7, 7),
    VIBRANIUM("Vibranium", "0x000000", 7, 8),
    SOLARIUM("SOLARIUM", "0x000000", 7, 7),
    VALYRIUM("Valyrium", "0x000000", 6, 7),
    URU("Uru", "0x000000", 6, 7),
    ADAMANT("Adamant", "0x000000", 7, 7),
    NUCLEUM("Nucleum", "0x000000", 7, 7),
    IOX("Iox", "0x000000", 10),
    SEISMUM("Seismum", "0x000000", 5, 6),
    IMPEROMITE("Imperomite", "0x000000", 6, 6),
    EEZO("Eezo", "0x38596A", 4, 5),
    DURANITE("Duranite", "0x000000", 5, 6),
    PROMETHIUM("Promethium", "0x000000", 5, 6),
    IGNITZ("Ignitz", "0x000000", 7, 7),
    PROXII("Proxii", "0x000000", 6, 6),
    OSRAM("Osram", "0x000000", 4),
    PALLADIUM("Palladium", "0x000000", 5, 9),
    YRDEEN("Yrdeen", "0x000000", 7, 7),
    NIOB("Niob", "0x000000", 6, 6),
