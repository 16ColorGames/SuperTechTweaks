...
public class ContainerBasicResearcher extends Container {

	private TileBasicResearcher te;

	public ContainerBasicResearcher(IInventory playerInventory, TileBasicResearcher te) {
		this.te = te;
