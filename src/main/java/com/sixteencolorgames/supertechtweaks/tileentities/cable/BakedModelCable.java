...
public class BakedModelCable implements IBakedModel {

	public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(
			SuperTechTweaksMod.MODID + ":blockcable");
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		Boolean north = extendedBlockState.getValue(BlockCable.NORTH);
		Boolean south = extendedBlockState.getValue(BlockCable.SOUTH);
		Boolean west = extendedBlockState.getValue(BlockCable.WEST);
		Boolean east = extendedBlockState.getValue(BlockCable.EAST);
		Boolean up = extendedBlockState.getValue(BlockCable.UP);
		Boolean down = extendedBlockState.getValue(BlockCable.DOWN);
		Material mat = extendedBlockState.getValue(BlockCable.MATERIAL);
